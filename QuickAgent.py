...
class TextToSpeech:
    ...
    MODEL_NAME = "aura-2-thalia-en"  # Example model name, change as needed
    ...
    def speak(self, text):
        ...
        # print("TTS URL:", DEEPGRAM_URL)  # Add this line
        headers = {
            ...
            for chunk in r.iter_content(chunk_size=1024):
                if chunk:
                    ...
                    try:
                        ...
                        # ffplay closed before we finished sending data
                        break
        ...
        if player_process.stdin:
            try:
                ...
                pass
        player_process.wait()
        stderr = player_process.stderr.read()
        if stderr:
            print(stderr.decode())
